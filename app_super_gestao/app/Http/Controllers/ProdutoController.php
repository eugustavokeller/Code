...
class ProdutoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $feedback = [
            'required' => 'O campo :attribute é obrigarório!',
            ...
            'nome.max' => 'O campo :attribute deve ter no maximo 3 caracteres.',
            'descricao.max' => 'O campo :attribute deve ter no maximo 3 caracteres.',
            'peso.integer' => 'O campo peso deve ser um inteiro',
            'unidade_id.exists' => 'O campo unidade deve ser selecionado.',
        ];
